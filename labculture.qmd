...
<div class="page-header"><h1 class="page-header__title">Lab Culture</h1></div>
...
<div class="page-header"><h1 class="page-header__title">Jo Lab Handbook</h1></div>
