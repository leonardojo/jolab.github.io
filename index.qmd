...
<div style="position: relative; width: 100vw; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; margin-top: -50px; margin-bottom: -20px; min-height: 70vh; overflow: hidden;">
  ...
  <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; display: flex; flex-direction: column; justify-content: flex-end; align-items: center; background: rgba(0,0,0,0); text-align: center; padding: 0 20px 5px 20px;">
